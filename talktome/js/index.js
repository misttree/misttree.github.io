var myBot = new BotUI('hello-world');
    ...
    myBot.message.add({ // show a message
      delay: 200,
      content: 'Hello, my name is HuiBin Zhang.'
    }).then (function (){
      myBot.message.add({
        delay: 1000,
        loading: true,
      ...
      switch (res.value) {
        ...
        case 'your contacts':
          ...
          delay: 1000,
          loading: true,
          content: `Go ahead, try [my website](http://nkcszhb.xyz) or <a href="mailto:nkcszhb@outlook.com">Email me.</a> </br>
                    Here is my [Github address](https://github.com/misttree).`
        });
        break;/*
        case 'your hobbies':
          return myBot.message.add ({
      ...
      switch (res.value) {
        case 'yes':
          return myBot.message.add({
            delay: 1000,
            loading: true,
            content: `OK Thanks, have a nice Day.`
          })
          ...
          case 'no':
            return myBot.message.add({
              delay: 1000,
              loading: true,
              content: `It doesn't matter,you can give me your advice.`
            })
        default:
